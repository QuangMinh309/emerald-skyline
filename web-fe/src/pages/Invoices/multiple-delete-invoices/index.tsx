...
import { useDeleteManyInvoices } from "@/hooks/data/useInvoices";
...
const DeleteManyInvoiceModal = ({
	open,
	setOpen,
	selectedIds,
	onSuccess,
}: Props) => {
	const { mutate: deleteMany, isPending } = useDeleteManyInvoices();
...
export default DeleteManyInvoiceModal;
