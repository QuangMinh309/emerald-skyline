...
import { useDeleteManyNotifications } from "@/hooks/data/useNotifications";
...
const DeleteManyNotificationModal = ({
	open,
	setOpen,
	selectedIds,
	onSuccess,
}: Props) => {
	const { mutate: deleteMany, isPending } = useDeleteManyNotifications();
...
export default DeleteManyNotificationModal;
